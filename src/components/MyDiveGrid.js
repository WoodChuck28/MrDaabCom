...
import "./styles/MyGrid.css"
  ...
  export default function MyGrid({
    ...
    const customBreakpoints = deepMerge(grommet, {
      ...
      const listAnimalsBoxes = diving.map(codeName => (
        ...
        >
          <Heading width="100%" height="30px" margin="none" level={1}><a className="gridBoxes" href={codeName}>{codeName}</a></Heading>
        </Box>
      ));
  ...
  return (
    <ResponsiveDivingGrid></ResponsiveDivingGrid>
  );
}
