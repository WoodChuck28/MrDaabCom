...
class DivingIntro extends Component {
  render() {
    return (
      ...
      <li><NavLink to="/pythonSyntax" style={{color: "white"}}>History of Sport</NavLink></li>
      <li><NavLink to="/pythonUsage" style={{color: "white"}}>How Competition Works</NavLink></li>
      <li><NavLink to="/pythonFrameworks" style={{color: "white"}}>Who is Successful?</NavLink></li>
      <li><NavLink to="/myPythonExamples" style={{color: "white"}}>Diving Examples</NavLink></li>
      </ul>
